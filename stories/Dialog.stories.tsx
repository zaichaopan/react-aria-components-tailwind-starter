...
export const WithNonTextContentHeaders = () => {
  return (
    <DialogTrigger>
...
export const WithIsDismissable = () => {
  return (
    <DialogTrigger>
      <Button>Edit profile</Button>
...
export const WithKeyboardDismissDisabled = () => {
  return (
    <DialogTrigger>
      <Button>Edit profile</Button>
...
export const WithAutoFocusWhenOpen = (args: any) => {
  return (
    <DialogTrigger>
      <Button>Edit profile</Button>
      <Modal {...args} size="md">
