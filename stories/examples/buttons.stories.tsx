      ...
      <div className="grid pt-10 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Box>
          <Button variant="plain" isIconOnly>
            <AccessibleIcon aria-label="Bookmark">
              <Bookmark />
            </AccessibleIcon>
          </Button>
        </Box>
        ...
        <Box>
          <div className="inline-flex items-stretch">
            <Button variant="outline" isIconOnly className="rounded-e-none">
              <AccessibleIcon aria-label="Increase">
                <ChevronUp />
              </AccessibleIcon>
            </Button>
            ...
            <Button variant="outline" isIconOnly className="rounded-s-none">
              <AccessibleIcon aria-label="Decrease">
                <ChevronDown />
              </AccessibleIcon>
            </Button>
          </div>
        ...
        <Box>
          <CopyButton
            copyText="https://github.com/zaichaopan/react-aria-components-tailwind-starter"
            label='Copy link'
        ...
        <Box>
          <ButtonGroup className="inline-flex">
            <Button isIconOnly variant="outline">
              <AccessibleIcon aria-label="Flip horizontal">
                <FlipHorizontal />
              </AccessibleIcon>
            </Button>
            <Button isIconOnly variant="outline">
              <AccessibleIcon aria-label="Flip vertical">
                <FlipVertical />
              </AccessibleIcon>
            </Button>
          </ButtonGroup>
        ...
        <Box>
          <ButtonGroup>
            ...
            <Button isIconOnly variant="outline">
              <AccessibleIcon aria-label="More">
                <EllipsisIcon />
              </AccessibleIcon>
            </Button>
          </ButtonGroup>
        ...
        <Box>
          <ButtonGroup>
            <Button isIconOnly>
              <AccessibleIcon aria-label="Left">
                <AlignLeft />
              </AccessibleIcon>
            </Button>
            <Button isIconOnly>
              <AccessibleIcon aria-label="Center">
                <AlignCenter />
              </AccessibleIcon>
            </Button>

            <Button isIconOnly>
              <AccessibleIcon aria-label="Right">
                <AlignRight />
              </AccessibleIcon>
            </Button>
          </ButtonGroup>
        ...
        <Box>
          <ButtonGroup>
            <Button isIconOnly>
              <AccessibleIcon aria-label="QR code">
                <QrCode />
              </AccessibleIcon>
            </Button>
        ...
        <Box>
          <ButtonGroup>
            ...
            <Button variant="outline" isIconOnly>
              <AccessibleIcon aria-label="Go to preview">
                <SquareArrowOutUpRight />
              </AccessibleIcon>
            </Button>
          </ButtonGroup>
        ...
        <Box>
          <div className="space-x-2">
            <Button variant="outline" isIconOnly>
              <AccessibleIcon aria-label="Login with Google">
                <GoogleIcon />
              </AccessibleIcon>
            </Button>
            <Button variant="outline" isIconOnly>
              <AccessibleIcon aria-label="Login with Facebook">
                <FacebookIcon />
              </AccessibleIcon>
            </Button>

            <Button variant="outline" isIconOnly>
              <AccessibleIcon aria-label="Login with X">
                <XIcon />
              </AccessibleIcon>
            </Button>

            <Button variant="outline" isIconOnly>
              <AccessibleIcon aria-label="Login with Github">
                <GithubIcon />
              </AccessibleIcon>
            </Button>
          </div>
