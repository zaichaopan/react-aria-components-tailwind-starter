  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="grid pt-10 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <Box>
          <Switch labelPosition="left">Right aligned switch</Switch>
        </Box>
        <Box>
          <SwitchField>
            <Switch>Right aligned checkbox</Switch>
            <Description>
              ...
              >
                <div className="relative isolate flex">
                  <div className="z-10 p-1.5">
                    <AccessibleIcon>
                      <Moon className="size-4 text-foreground transition group-selected:text-muted/75" />
                    </AccessibleIcon>
                  </div>

                  <div className="z-10 p-1.5">
                    <AccessibleIcon>
                      <Sun className="size-4 text-muted/75 transition group-selected:text-foreground" />
                    </AccessibleIcon>
                  </div>
