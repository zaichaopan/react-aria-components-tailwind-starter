...
export const AvatarIconFallbacks = () => {
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-end gap-4">
...
AvatarIconFallbacks.parameters = {
  docs: {
    description: {
      story:
        'Use the **fallback="icon"** to show a placeholder avatar icon when image src is unavailable.',
    },
  },
};
...
export const InitialWithSingleColor = () => {
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-end gap-4">
        <Avatar alt="A J" className="rounded-full" colorless fallback="icon" />
        <Avatar alt="T O" className="rounded-full" colorless fallback="icon" />
        <Avatar alt="E M" className="rounded-full" colorless fallback="icon" />
        <Avatar alt="D T" className="rounded-full" colorless fallback="icon" />
      </div>
    </div>
  );
};
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center">
        <AvatarGroup>
          ...
          <Avatar className="size-8 rounded-full" alt="D P" colorless fallback='icon' />
        </AvatarGroup>
