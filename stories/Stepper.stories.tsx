...
export function MultiStepsForm() {
  ...
  return (
    <div className="mx-auto max-w-xl p-12">
      ...
      <SubHeading>Complete all steps to finish your Registration</SubHeading>
              ...
              >
                <StepPanel step={1}>
                  <section className="grid gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <TextField name="phoneNumber" className="col-span-full">
                      <Label requiredHint>Phone Number</Label>
                ...
                <StepPanel step={2}>
                  <section className="grid gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <TextField name="zipCode" className="col-span-full">
                      <Label requiredHint>ZIP Code</Label>
                ...
                <StepPanel step={3}>
                  <section className="grid gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <RadioGroup name="contactMethod" className="col-span-full">
