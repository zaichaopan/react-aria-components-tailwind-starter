    ...
    >
      {(renderProps) => (
        <>
          <div
            className={twMerge(
              'flex h-6 w-11 shrink-0 cursor-default items-center rounded-full bg-zinc-200 ring-1 ring-zinc-300/90 p-0.5 dark:bg-zinc-700 dark:inset-ring-white/10 dark:inset-ring-1 dark:ring-0',
              size !== 'lg' && 'sm:h-5 sm:w-8',
              labelPlacement === 'end' ? 'me-3' : 'ms-3',
              renderProps.isReadOnly && 'opacity-50',
              renderProps.isSelected && 'bg-accent dark:bg-accent ring-accent inset-ring-[rgba(255,255,255,0.1)]',
