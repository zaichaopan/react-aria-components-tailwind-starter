...
### Header Display level

Both `DialogHeader` and `DialogTitle` like <a href="./?path=/docs/heading--docs" target="_blank">**Heading**</a> accepts `displayLevel` prop to control the heading level. The default value is `2`.

<Canvas of={DialogsStories.HeaderLevel} />


### Sub Header

<Canvas of={DialogsStories.SubHeader} />
