...
<Canvas of={ButtonStories.CustomButtonBackgroundAndColor} />
...
<Canvas of={ButtonStories.ButtonWithDisabledState} />
...
<Canvas of={ButtonStories.ButtonWithDisabledStateAndTooltip} />
...
<Canvas of={ButtonStories.ButtonWithPendingState} />

## Custom spinner

Use the **isCustomPending** prop if you need a custom pending ui.

<Canvas of={ButtonStories.ButtonWithCustomPendingUI} />
