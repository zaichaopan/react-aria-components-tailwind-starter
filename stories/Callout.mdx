...
<Canvas of={CalloutStories.CalloutTitles} />

## Descriptions

<Canvas of={CalloutStories.CalloutDescriptions} />


## Colors
 Use the `color` prop to set the callout color. Available colors are `blue`, `red`, `green`, `yellow`. Use `className="[--callout:var(--color-<color>-<shade>)]"` to set custom colors.
