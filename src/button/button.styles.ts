  ...
  const style = {
    ...
    variant: {
      base: [
        ...
        variant === 'solid'
          ? [
              '[--btn-bg:var(--color-accent)] [--btn-color:lch(from_var(--btn-bg)_calc((49.44_-_l)_*_infinity)_0_0)]',
              color === 'red' &&
          ...
          : [
              ...
              color === 'accent' && '[--btn-color:var(--color-accent)]',
              color === 'red' && '[--btn-color:var(--color-red-600)]',
      ...
      outline: [
        ...
        !isIconOnly && '[--icon-color:var(--color-muted)]/75',
      ],
      plain: [
      ...
      link: [
        'underline underline-offset-4 decoration-(--btn-color)/50',
