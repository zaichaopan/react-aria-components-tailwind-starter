      ...
      {placements.map((placement) => {
        return (
          <Select key={placement}>
            ...
            <SelectPopover>
              <SelectListBox checkIconPlacement={placement}>
...
export const ItemWithSecondaryTexts = () => {
  return (
    <Select
    ...
    <Form className="space-y-4">
      <Select isRequired placeholder="Select status&hellip;" className="gap-2">
        <div className="flex items-center gap-2">
          <Label className="mt-1 mb-0 self-start">Project status</Label>
          <div>
