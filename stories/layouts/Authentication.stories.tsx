        ...
        <div className="flex flex-col">
          ...
          <div>
            <div className="flex flex-col p-6 text-center">
              ...
              <SubHeading>Welcome back! Please sign in to continue</SubHeading>
            </div>
            ...
            <Form method="post" className="p-6 pt-0">
              ...
              <TextField isRequired>
                <div className="flex pb-1">
                  ...
                  <TextLink className="ms-auto mb-1 no-underline">
                    Forgot password?
                  </TextLink>
                </div>
                <PasswordInput />
          ...
          <Text className="px-6 text-center">
            No account? <TextLink>Create an account</TextLink>
          </Text>
        </div>
      </div>
    </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="">
            <div className="flex flex-col p-6 text-center">
              ...
              <SubHeading>Welcome! Please fill in the details to get started.</SubHeading>
            </div>
            ...
            <Form method="post" className="p-6 pt-0">
              ...
              <Text className="text-center">
                ...
                <TextLink>Teams of Service</TextLink> and&nbsp;
                <TextLink>Privacy Policy</TextLink>.
              </Text>

              <Text className="text-center">
                Already have an account?{' '}
                <TextLink className="underline">Sign in</TextLink>
              </Text>
            </Form>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div>
            <div className="flex flex-col p-6 text-center">
              ...
              <SubHeading>
                Enter your email below and we&apos;ll send you password reset
                instructions
              </SubHeading>
            </div>
            ...
            <Form method="post" className="p-6 pt-0">
              ...
              <Text className="text-center">
                ...
                filter for an email from <TextLink>support@acme.com</TextLink>
              </Text>
            </Form>
          </div>
          <Text className="text-center">
            Back to&nbsp;<TextLink>Sign In</TextLink>
          </Text>
        </div>
      </div>
    </div>
