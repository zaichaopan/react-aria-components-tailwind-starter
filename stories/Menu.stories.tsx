...
export const WithPopoverPlacements = () => {
  return (
    <MenuTrigger>
      <MenuButton>Actions</MenuButton>
...
export const WithIconKbdShortcutAndDescriptions = () => {
  return (
    <MenuTrigger>
      <MenuButton>Actions</MenuButton>
      <MenuPopover>
...
export const WithDestructiveItems = () => {
  return (
    <MenuTrigger>
      <MenuButton>Actions</MenuButton>
      <MenuPopover>
...
export const WithAvatarTriggers = () => {
  return (
    <MenuTrigger>
...
export const WithCustomTriggers = () => {
  return (
    <MenuTrigger>
      <MenuButton
        variant="unstyle"
...
export const WithMultiSelections = () => {
...
export const WithSelectedIconPlacement = () => {
  const [selected, setSelected] = React.useState<Selection>(new Set(['left']));
...
export const WithSectionLevelSelections = () => {
