...
export const WithLabelPlacement = () => {
  return (
    <SwitchField>
...
export const WithAnimatedHandleIcons = () => {
  return (
    <Switch
      ...
      render={({ isSelected, isFocusVisible }) => (
        <div
          className={twMerge(
            'flex rounded-full border border-zinc-200 dark:border-zinc-700 bg-zinc-200 p-px transition-[background] ease-in-out dark:bg-zinc-700',
        ...
        >
          <div className="relative isolate flex">
            ...
            <div
              className={twMerge(
                'z-10 grid size-6 translate-x-0 place-items-center opacity-100 transition-all ease-in-out text-muted',
