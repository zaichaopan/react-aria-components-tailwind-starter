...
<Canvas of={DialogsStories.WithHeaders} />

### With non-text content headers
...
<Canvas of={DialogsStories.WithNonTextContentHeaders} />

## Without header

Without **DialogHeader**, dialog trigger button text will be used as dialog header.

<Canvas of={DialogsStories.WithNoHeader} />
...
<Canvas of={DialogsStories.WithFooters} />
...
<Canvas of={DialogsStories.WithIsDismissable} />

## With isKeyboardDismissDisabled
...
<Canvas of={DialogsStories.WithKeyboardDismissDisabled} />

## With auto focus when open
